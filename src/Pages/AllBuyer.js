            ...
            buyer.map((user, i) => (
              <tr key={user._id}>
                ...
                <td>{ user?.verify  !== 'verified' ?
                    <button onClick={()=> handleVerifyBuyer(user._id)} className=" tooltip tooltip-primary text-4xl text-center text-primary" data-tip="Verify Buyer?"><FaQuestionCircle/></button> : <div className="tooltip tooltip-secondary" data-tip="Already Verified">
